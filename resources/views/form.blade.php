      ...
      <div class="border-b border-gray-900/10 pb-8">
        ...
        <div class="mt-10 grid grid-cols-6 gap-x-6 gap-y-8">
          ...
          <div class="col-span-full">
            ...
            <p class="mt-3 text-sm leading-6 text-gray-600">Neste campo, você precisa informar o responsável pela reunião/ata. Você mesmo.</p>
          </div>

          <div class="col-span-full">
            <label for="nomeCompleto" class="block text-sm font-medium leading-6 text-gray-900 mb-2">Nome dos participantes:</label>
            <input type="text" id="nomeCompleto" placeholder="Digite o nome completo" class="border-2 py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <textarea id="resumo" name="about" rows="2" class="block w-full rounded-md border-0 pl-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Aqui você pode descrever de forma resumida o assunto da sua reunião. Fique à vontade."></textarea>
            </div>
          </div>

          <div class="col-span-full">
            <label for="about" class="block text-sm font-medium leading-6 text-gray-900">Tópicos comentados na reunião</label>
            <div class="mt-2">
            ...
            <p class="mt-3 text-sm leading-6 text-gray-600">Descreva os tópicos comentados na reunião.</p>
          </div>
          ...
          <div class="col-span-full mb-0">
            <label for="photo" class="block text-sm font-medium leading-6 text-gray-900">Área destinada à assinatura do responsável pela ata</label>
