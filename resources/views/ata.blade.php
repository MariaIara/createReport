        ...
        <div class="">
            <div class="ml-52">
                ...
                <div class="mt-6 flex gap-x-4">
                    <div class="w-fit">
                        <input id="emailAddress" name="email" type="email" autocomplete="email" required class="w-96 flex-auto rounded-md border-0 bg-indigo-200 px-3.5 py-3 text-black shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6 placeholder:text-gray-600" placeholder="Digite um e-mail">
                    </div>
